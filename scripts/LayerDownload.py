...
set_i = 0
projectname = arcpy.GetParameterAsText(set_i); set_i = set_i + 1
layerlist = json.loads(arcpy.GetParameterAsText(set_i)); set_i = set_i + 1
...
arcpy.SetParameter(set_i, os.path.join(optfolder, zipname)); set_i = set_i + 1
